...
Code-level API documentation is generated by Doxygen from the `/** ... */` comments
in the source tree. The docs are rebuilt on every push to `main` and deployed to
GitHub Pages automatically via `.github/workflows/docs.yml`.

### Live docs

```
https://<your-username>.github.io/ESP32_WoL_IP_Fordwarder
```
...
On PRs the workflow uploads a preview artifact (`doxygen-html.zip`) instead of
