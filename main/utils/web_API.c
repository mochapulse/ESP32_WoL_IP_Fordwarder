...
extern const uint8_t components_css_start[]  asm("_binary_components_css_start");
extern const uint8_t components_css_end[]    asm("_binary_components_css_end");
extern const uint8_t formatters_js_start[]   asm("_binary_formatters_js_start");
extern const uint8_t formatters_js_end[]     asm("_binary_formatters_js_end");
extern const uint8_t metrics_js_start[]      asm("_binary_metrics_js_start");
extern const uint8_t metrics_js_end[]        asm("_binary_metrics_js_end");
extern const uint8_t store_js_start[]        asm("_binary_store_js_start");
extern const uint8_t store_js_end[]          asm("_binary_store_js_end");
...
static const embedded_file_t s_files[] = {
    ...
    {"/css/layout.css",  "text/css",               layout_css_start,     layout_css_end},
    {"/css/components.css","text/css",             components_css_start, components_css_end},
    {"/js/formatters.js","application/javascript", formatters_js_start,  formatters_js_end},
    {"/js/metrics.js",   "application/javascript", metrics_js_start,     metrics_js_end},
    {"/js/store.js",     "application/javascript", store_js_start,       store_js_end},
    {"/js/charts.js",    "application/javascript", charts_js_start,      charts_js_end},
    {"/js/dashboard.js", "application/javascript", dashboard_js_start,   dashboard_js_end},
...
static esp_err_t status_handler(httpd_req_t *req)
{
    ...
    if (wifi_health() && esp_wifi_sta_get_ap_info(&ap_info) == ESP_OK) {
